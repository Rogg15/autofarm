...
local Fling = false --// Recommended: true
local FlingBlockInvisible = false --// Recommended: true (So you can see the flinging block)
...
local GunHatId = 5063578607-- // (https://www.roblox.com/catalog/4933294084/Type-37-Pulse-Rifle)
...
HEADLERP.Part0 = Head
HEADLERP.Part1 = Head
HEADLERP.C0 = CFrame.new(0, -15, -0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))
...
RIGHTARMLERP.C0 = CFrame.new(-1.2, 0, -0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))

local LEFTARMLERP = Instance.new("ManualWeld")
LEFTARMLERP.Parent = LeftArm
LEFTARMLERP.Part0 = LeftArm
LEFTARMLERP.Part1 = Torso
LEFTARMLERP.C0 = CFrame.new(1.1, 0, -0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))
...
GUN_A1=Align(GunHandle,tommygun,Vector3.new(0, -0.1, -1.6),Vector3.new(-260,-280,-90))
tommygunweld.Part0 = tommygun
tommygunweld.Part1 = RightArm
tommygunweld.C0 = tommygun.CFrame:inverse() * RightArm.CFrame * CFrame.new(10,-.80,1.15) * CFrame.Angles(math.rad(98),math.rad(0),0)
...
tommygunammoweld.C0 = tommygun.CFrame:inverse() * tommygun.CFrame * CFrame.new(0,.4,.25) * CFrame.Angles(math.rad(0),math.rad(150),0)
